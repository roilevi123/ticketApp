...
public class FullCompanyManagementTest {
    ...
    void appointManagerFailedUserSuspended(){
        ...
        Response<String> response = companyService.AppointAManager(idA, "company", new HashSet<>(), userToken);
    ...
    void appointOwnerFailedUserSuspended(){
        ...
        Response<String> response = companyService.AppointOwner(idA, "company", userToken);
