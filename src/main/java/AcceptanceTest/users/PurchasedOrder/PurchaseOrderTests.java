...
//        }
    ...
    public boolean GetCompanyTransactionSuccess7() {
        ...
        eventService.createEvent(token, "1", "1", EventType.PLAY, 100, new Date(), "1", "1", getMapArea());
        eventService.createEvent(token, "2", "2", EventType.PLAY, 100, new Date(), "2", "1", getMapArea());
    ...
    public boolean GetCompanyTransactionSecurity8() {
        ...
        companyService.CreateCompany("Company1", tokenOwner1);
        eventService.createEvent(tokenOwner1, "Event1", "Company1", EventType.PLAY, 100, new Date(), "Loc1", "1", getMapArea());

        userService.register("owner2", "pass");
        String tokenOwner2 = userService.login("owner2", "pass");
        companyService.CreateCompany("Company2", tokenOwner2);
        eventService.createEvent(tokenOwner2, "Event2", "Company2", EventType.PLAY, 100, new Date(), "Loc2", "1", getMapArea());
    ...
    public boolean GetCompanyTransactionMultipleEvents9() {
        ...
        eventService.createEvent(token, "EventA", "1", EventType.PLAY, 100, new Date(), "LocA", "1", getMapArea());
        eventService.createEvent(token, "EventB", "1", EventType.PLAY, 100, new Date(), "LocB", "1", getMapArea());
